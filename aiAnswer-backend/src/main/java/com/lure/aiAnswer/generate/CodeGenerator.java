package com.lure.aiAnswer.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.lure.aiAnswer";
        ...
        projectPath = projectPath + "/springboot-init-master/";
        // 参考路径，可以自己调整下面的 outputPath
        String inputPath = projectPath + File.separator + "springboot-init-master"+"src/main/resources/templates/模板名称.java.ftl";
