...
import com.lure.aiAnswer.manager.AiManager;
import com.lure.aiAnswer.model.dto.question.*;
...
import com.lure.aiAnswer.model.vo.QuestionVO;
import com.lure.aiAnswer.service.AppService;
import com.lure.aiAnswer.service.QuestionService;
...
public class QuestionController {
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest, HttpServletRequest request, boolean isVip) {
        ThrowUtils.throwIf(aiGenerateQuestionRequest == null, ErrorCode.PARAMS_ERROR);
        // 获取参数
        Long appId = aiGenerateQuestionRequest.getAppId();
        int questionNumber = aiGenerateQuestionRequest.getQuestionNumber();
